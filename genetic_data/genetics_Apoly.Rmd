...
dapcPoptbl <- tibble(pop =gl@pop, 
                     inds =gl@ind.names, 
                     gdapcPop =factor(dapcPop$assign, levels = c("Sudbury reef/Vlassof Cay", 
                                                                "Tongue Reef", 
                                                                "Chauvel Reef", 
                                                                "Keswick/Cockermouth island")), 
                     xdapcPop = dapcPop$ind.coord[,1], ydapcPop =dapcPop$ind.coord[,2])
...
g2 <- ggplot(dapctbl, aes(xdapcPop, fill =gl@pop, color = gl@pop)) + 
