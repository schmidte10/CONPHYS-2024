...
###### rmr.3a (linear)
```{r rest-model-valid-1, fig.width=8, fig.height=8, message=FALSE, warning=FALSE, echo=FALSE}
...
mmr.1a %>% performance::check_model()
```
...
mmr.1.p2a %>% performance::check_model()
```
...
nas.g2 <- ggplot(nas.emm.df, aes(y=emmean, x=TEMPERATURE, color=REGION)) + 
